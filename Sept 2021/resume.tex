...
\begin{document}
	...
	\begin{itemize}[leftmargin=0.0in]
		...
		\cventry{July 2021 - Present}{\href{https://atlan.com/}{Atlan Technologies Pvt. Ltd.}}{Backend Engineering Intern}{}{}{ \setlength{\itemindent}{.2in} \setlength\itemsep{.3em}
			\item Building the data ingestion platform for the next generation of the product and scalable cloud native ETL jobs to fetch metadata from various data sources
			\vspace{-3pt}
			\item Python, Kotlin, JDBC, Kubernetes, Argo Workflows, Apache Atlas
		}
